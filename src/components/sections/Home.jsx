...
export const Home = () => {
    ...
    ">
        ...
        <div className="text-center z-10 px-4">
            <h1 className="text-5xl md:text-7xl font-bold mb-6 bg-gradient-to-r from-blue-500 to-red-700 bg-clip-text text-transparent leading-right">
                Hi, I am Ryan
            </h1>

            <p className="text-gray-100 text-lg mb-8 max-w-lg mx-auto">
                Lorem ipsum dolor sit, amet consectetur adipisicing elit. Beatae facere culpa tenetur libero reprehenderit natus, error nesciunt voluptatibus eos atque laudantium, quaerat iusto sequi commodi dolorum similique rem perferendis recusandae.
            </p>
