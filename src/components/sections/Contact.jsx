...
export const Contact = () => {
    ...
    return <section id="contact" className="min-h-screen flex items-center justify-center sm:w-full py-20">
        <RevealOnScroll>

            <div className="px-4 w-80">

                <h2 className="text-5xl font-bold mb-8 bg-gradient-to-l from-blue-700 to-red-800 bg-clip-text text-transparent text-center">Get in Touch</h2>
